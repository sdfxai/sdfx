  ...
  <div class="tw-textarea bg-transparent p-0 border-0">
    ...
    <div class="relative w-full rounded-md shadow-sm">
      <textarea 
        ...
        :class="{
          'bg-zinc-100/20 text-zinc-500 dark:bg-zinc-700 cursor-not-allowed':disabled,
          'bg-white/50 dark:bg-zinc-950/60 text-zinc-800 dark:text-zinc-200':!disabled
        }"
        class="hidden-scrollbars rounded-xl appearance-none block w-full px-5 py-4 border-2 border-zinc-300 dark:border-zinc-700/80 placeholder-zinc-600 dark:placeholder-zinc-700 focus:placeholder-zinc-400 focus:outline-none focus:shadow-outline-teal focus:border-teal-300 transition duration-150 text-xl xl:text-2xl leading-6 xl:leading-8 font-semibold ease-in-out"
      />
