/**
 * Rounded corners polyfill for CanvasRenderingContext2D
 */
// @ts-ignore
if (typeof(window) !== 'undefined' && window.CanvasRenderingContext2D && !window.CanvasRenderingContext2D.prototype.roundRect) {
  // @ts-ignore
  window.CanvasRenderingContext2D.prototype.roundRect = function(x: number, y: number, w: number, h: number, radius: any, radius_low?: number) {
