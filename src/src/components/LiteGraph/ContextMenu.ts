 ...
 */
function ContextMenu(this: any, values: any[], options: any = {}) {
  ...
  // TODO: check with vincent if it is px or % to put it in a string
  // @ts-ignore
  ...
  function on_mouse_wheel(e: any) {
    ...
    // e.preventDefault() disable for passive events
    return true
  }
  ...
  */
  ...
  LiteGraph.pointerListenerAdd(root, 'enter', function (e: any) {
...
ContextMenu.prototype.addItem = function (name: string, value: any, options: any = {}) {
  var that = this
...
ContextMenu.prototype.close = function (e: any, ignore_parent_menu: any) {
...
ContextMenu.trigger = function (element: any, event_name: string, params: any, origin?: any) {
...
ContextMenu.isCursorOverElement = function (event: any, element: any) {
