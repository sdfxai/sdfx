...
supported callbacks:
  ...
  + onDrawForeground: render the widgets inside the node
...
function LNode(title?: string) {
  // @ts-ignore
  this._ctor(title)
}

LNode.prototype._ctor = function (title?: string) {
 ...
 * @method configure
 */
LNode.prototype.configure = function (info: any) {
  if (this.graph) {
    this.graph._version++
  }
  for (var j in info) {
...
LNode.prototype.serialize = function (options: any = {}) {
  ...
  if (this.constructor === LNode && this.last_serialization) {
  ...
  if (this.widgets && this.serialize_widgets) {
    o.widgets_values = []
    if (options.full_widgets) {
      o.widgets = this.widgets.map((w: any) => ({
        name: w.name,
        type: w.type,
        value: w.value,
        options: w.options
...
LNode.prototype.clone = function () {
...
//LNode.prototype.deserialize = function(info) {} //this cannot be done from within, must be done in LiteGraph
...
LNode.prototype.getTitle = function () {
 ...
 * @param {*} value
 */
LNode.prototype.setProperty = function (name: string, value: any) {
  if (!this.properties) {
    this.properties = {}
  }
 ...
 * @param {*} data
 */
LNode.prototype.setOutputData = function (slot: number, data: any) {
  if (!this.outputs) {
    return
  }
 ...
 */
LNode.prototype.setOutputDataType = function (slot: number, type: string) {
  if (!this.outputs) {
    return
  }
  if (slot == -1 || slot >= this.outputs.length) {
 ...
 */
LNode.prototype.getInputData = function (slot: number, force_update: boolean) {
  if (!this.inputs) {
    return
  } //undefined;
 ...
 */
LNode.prototype.getInputDataType = function (slot: number) {
  if (!this.inputs) {
    return null
  } //undefined;
 ...
 */
LNode.prototype.getInputDataByName = function (slot_name: string, force_update: boolean) {
 ...
 * @return {boolean}
 */
LNode.prototype.isInputConnected = function (slot: number) {
  if (!this.inputs) {
    return false
  }
 ...
 */
LNode.prototype.getInputInfo = function (slot: number) {
  if (!this.inputs) {
    return null
  }
 ...
 */
LNode.prototype.getInputLink = function (slot: number) {
  if (!this.inputs) {
    return null
  }
  if (slot < this.inputs.length) {
 ...
 * @method getInputNode
 * @param {number} slot
 * @return {LNode} node or null
 */
LNode.prototype.getInputNode = function (slot: number) {
  if (!this.inputs) {
    return null
  }
  if (slot >= this.inputs.length) {
 ...
 * @return {*} value
 */
LNode.prototype.getInputOrProperty = function (name: string) {
 ...
 */
LNode.prototype.getOutputData = function (slot: number) {
  if (!this.outputs) {
    return null
  }
 ...
 */
LNode.prototype.getOutputInfo = function (slot: number) {
  if (!this.outputs) {
    return null
  }
  if (slot < this.outputs.length) {
 ...
 * @return {boolean}
 */
LNode.prototype.isOutputConnected = function (slot: number): boolean {
  if (!this.outputs) {
    return false
  }
 ...
 * @return {boolean}
 */
LNode.prototype.isAnyOutputConnected = function (): boolean {
  if (!this.outputs) {
    return false
  }
  for (var i = 0; i < this.outputs.length; ++i) {
 ...
 * @return {array}
 */
LNode.prototype.getOutputNodes = function (slot: number) {
...
LNode.prototype.addOnTriggerInput = function () {
...
LNode.prototype.addOnExecutedOutput = function () {
...
LNode.prototype.onAfterExecuteNode = function (param: string, options: any) {
  const trigS = this.findOutputSlot('onExecuted')
  if (trigS != -1) {
...
LNode.prototype.changeMode = function (modeTo: any) {
  switch (modeTo) {
...
LNode.prototype.dock = function (docked: boolean) {
  this.docked = docked
  return this.docked
}
 ...
 * @param {*} options
 */
LNode.prototype.doExecute = function (param: string, options?: any) {
  options = options || {}
  if (this.onExecute) {
 ...
 * @param {*} param
 */
LNode.prototype.actionDo = function (action: string, param: string, options?: any) {
  options = options || {}
  if (this.onAction) {
    // enable this to give the event an ID
 ...
 * @param {*} param
 */
LNode.prototype.trigger = function (action: string, param: string, options?: any) {
 ...
 */
LNode.prototype.triggerSlot = function (slot: number, param: any, link_id?: number, options?: any) {
  options = options || {}
  if (!this.outputs) {
    return
  }
 ...
 * @param {Number} link_id [optional] in case you want to trigger and specific output link in a slot
 */
LNode.prototype.clearTriggeredSlot = function (slot: number, link_id?: number) {
  if (!this.outputs) {
    return
  }
 ...
 * @param {vec2} size
 */
LNode.prototype.setSize = function (size: number[]) {
  this.size = size
 ...
 */
LNode.prototype.addProperty = function (name: string, default_value: any, type: string, extra_info?: any) {
  const o: any = { name: name, type: type, default_value: default_value }
  if (extra_info) {
 ...
 */
LNode.prototype.addOutput = function (name: string, type: string, extra_info?: any) {
  const output: any = { name: name, type: type, links: null }
  if (extra_info) {
 ...
 */
LNode.prototype.addOutputs = function (array: any[]) {
  for (var i = 0; i < array.length; ++i) {
    const info = array[i]
    const o: any = { name: info[0], type: info[1], link: null }
    if (array[2]) {
      for (var j in info[2]) {
        o[j] = info[2][j]
      }
 ...
 * @param {number} slot
 */
LNode.prototype.removeOutput = function (slot: number) {
 ...
 */
LNode.prototype.addInput = function (name: string, type?: any, extra_info?: any) {
  type = type || 0
  const input: any = { name: name, type: type, link: null }
  if (extra_info) {
    for (var i in extra_info) {
 ...
 * @param {Array} array of triplets like [[name,type,extra_info],[...]]
 */
LNode.prototype.addInputs = function (array: any[]) {
 ...
 * @param {number} slot
 */
LNode.prototype.removeInput = function (slot: number) {
 ...
 */
LNode.prototype.addConnection = function (name: string, type: any, pos: number[], direction: string) {
  var o: any = {
    name: name,
    type: type,
    pos: pos,
 ...
 */
LNode.prototype.computeSize = function (out: any) {
...
LNode.prototype.inResizeCorner = function(canvasX: number, canvasY: number) {
  ...
  m.forEach((c, i) => {
    if (!inrc) {
      inrc = LiteGraph.isInsideRectangle(canvasX, canvasY, c[0], c[1], 20, 20)
      if (inrc) {
        corner = i
      }
    }
  ...
  return {
    result: inrc,
    corner: corner % 2 ? 'sw' : 'se'
  }
}

LNode.prototype.setResizeHandle = function(canvasX: number, canvasY: number) {
 ...
 */
LNode.prototype.getPropertyInfo = function (property: string) {
  let info = null
 ...
 */
LNode.prototype.addWidget = function (type: string, name: string, value: string, callback: any, options?: any) {
  if (!this.widgets) {
    this.widgets = []
  }
...
LNode.prototype.addCustomWidget = function (custom_widget: any) {
  if (!this.widgets) {
    this.widgets = []
  }
 ...
 */
LNode.prototype.getBounding = function (out: any) {
 ...
 * @return {boolean}
 */
LNode.prototype.isPointInside = function (x: number, y: number, margin?: number, skip_title?: boolean) {
  margin = margin || 0
 ...
 */
LNode.prototype.getSlotInPosition = function (x: number, y: number) {
  //search for inputs
 ...
 */
LNode.prototype.findInputSlot = function (name: string, returnObj?: boolean) {
  if (!this.inputs) {
    return -1
  }
  for (var i = 0, l = this.inputs.length; i < l; ++i) {
 ...
 * @return {number_or_object} the slot (-1 if not found)
 */
LNode.prototype.findOutputSlot = function (name: string, returnObj?: boolean) {
 ...
 * @return {number_or_object} the slot (-1 if not found)
 */
LNode.prototype.findInputSlotFree = function (optsIn?: any) {
  var optsIn = optsIn || {}
 ...
 * @return {number_or_object} the slot (-1 if not found)
 */
LNode.prototype.findOutputSlotFree = function (optsIn?: any) {
  var optsIn = optsIn || {}
  var optsDef = { returnObj: false, typesNotAccepted: [] }
  var opts = Object.assign(optsDef, optsIn)
  if (!this.outputs) {
 ...
 */
LNode.prototype.findInputSlotByType = function (type: any, returnObj?: boolean, preferFreeSlot?: boolean, doNotUseOccupied?: boolean) {
 ...
 */
LNode.prototype.findOutputSlotByType = function (type: any, returnObj?: boolean, preferFreeSlot?: boolean, doNotUseOccupied?: boolean) {
 ...
 * @return {number_or_object} the slot (-1 if not found)
 */
LNode.prototype.findSlotByType = function (input: boolean, type: any, returnObj?: boolean, preferFreeSlot?: boolean, doNotUseOccupied?: boolean) {
  input = input || false
  returnObj = returnObj || false
  ...
  for (let i = 0, l = aSlots.length; i < l; ++i) {
    let tFound = false
    const aSource: any = (type + '').toLowerCase().split(',')
    let aDest: any = aSlots[i].type == '0' || aSlots[i].type == '*' ? '0' : aSlots[i].type
 ...
 * @param {LNode} node the target node
 * @param {string} target_type the input slot type of the target node
 * @return {Object} the link_info is created, otherwise null
 */
LNode.prototype.connectByType = function (slot: any, target_node: any, target_slotType: any, optsIn?: any) {
  var optsIn = optsIn || {}
 ...
 * @return {Object} the link_info is created, otherwise null
 */
LNode.prototype.connectByTypeOutput = function (slot: any, source_node: any, source_slotType: any, optsIn?: any) {
  var optsIn = optsIn || {}
 ...
 * @return {Object} the link_info is created, otherwise null
 */
LNode.prototype.connect = function (slot: any, target_node: any, target_slot: any) {
 ...
 * @param {number_or_string} slot (could be the number of the slot or the string with the name of the slot)
 * @param {LNode} target_node the target node to which this slot is connected [Optional, if not target_node is specified all nodes will be disconnected]
 * @return {boolean} if it was disconnected successfully
 */
LNode.prototype.disconnectOutput = function (slot: any, target_node: any) {
  if (slot.constructor === String) {
    slot = this.findOutputSlot(slot)
    if (slot == -1) {
      if (LiteGraph.debug) {
 ...
 * @return {boolean} if it was disconnected successfully
 */
LNode.prototype.disconnectInput = function (slot: any) {
  //seek for the output slot
  if (slot.constructor === String) {
 ...
 **/
LNode.prototype.getConnectionPos = function (is_input: boolean, slot_number: any, out: any) {
...
/* Force align to grid */
LNode.prototype.alignToGrid = function (size=LiteGraph.CANVAS_GRID_SIZE) {
  this.pos[0] = size * Math.round(this.pos[0] / size)
  this.pos[1] = size * Math.round(this.pos[1] / size)
}

/* Console output */
LNode.prototype.trace = function (msg: string) {
  if (!this.console) {
    this.console = []
  }
  ...
  // @ts-ignore
  if (this.console.length > LNode.MAX_CONSOLE) {
    this.console.shift()
  }
...
/* Forces to redraw or the main canvas (LNode) or the bg canvas (links) */
LNode.prototype.setDirtyCanvas = function (dirty_foreground: any, dirty_background: any) {
  if (!this.graph) {
    return
  }
...
LNode.prototype.loadImage = function (url: string) {
  var img = new Image()
...
LNode.prototype.captureInput = function (v: any) {
 ...
 * @method collapse
 **/
LNode.prototype.collapse = function (force: boolean) {
  this.graph._version++
...
LNode.prototype.pin = function (v?: any) {
  this.graph._version++
  if (v === undefined) {
...
LNode.prototype.localToScreen = function (x: number, y: number, graphcanvas: any) {
