<template>
  <section class="AppList">
    <div v-if="appList.length<=0" class="mt-8 p-6 flex flex-col items-center justify-center h-full">
    ...
    <section v-if="factoryAppList.length>0" class="">
      <h2 class="text-sm font-semibold text-zinc-500">Factory Apps</h2>
      <div class="mt-2 grid grid-cols-2 gap-3">
        <div
          v-for="app in factoryAppList"
          :key="app.uid"
        >
          <dt
    ...
    <section v-if="userAppList.length>0" class="mt-8">
      <h2 class="text-sm font-semibold text-zinc-500">My Apps</h2>
      <div class="mt-2 grid grid-cols-2 gap-3">
        <div
          v-for="app in userAppList"
          :key="app.uid"
        >
          <dt
            @click="showAppLoader(app?.uid)"
