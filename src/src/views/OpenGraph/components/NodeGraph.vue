<template>
  <section class="litegraph relative w-full h-full overflow-hidden">
    ...
    <!-- bottom toolbar -->
    <div class="GraphToolbar absolute right-0 bottom-0 z-[100] overflow-hidden shadow border border-zinc-100 dark:border-zinc-800/60 font-semibold bg-white dark:bg-zinc-950/80 m-3 flex rounded-full divide-x divide-zinc-200 dark:divide-zinc-800/80">
