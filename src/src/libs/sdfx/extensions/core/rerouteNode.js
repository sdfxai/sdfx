...
import { LiteGraph, LCanvas as LGraphCanvas } from '@/components/LiteGraph/'

import {
  mergeIfValid,
  getWidgetConfig,
  setWidgetConfig,
} from './widgetInputs.js'

// Node that allows you to redirect connections for cleaner graphs

app.registerExtension({
  name: 'SDFX.RerouteNode',
  registerCustomNodes(app) {
    class RerouteNode {
      ...
      static setDefaultTextVisibility(visible) {
        ...
        if (visible) {
          localStorage['SDFX.RerouteNode.DefaultVisibility'] = 'true'
        } else {
          delete localStorage['SDFX.RerouteNode.DefaultVisibility']
        }
      }
    }
    ...
    RerouteNode.setDefaultTextVisibility(
      !!localStorage['SDFX.RerouteNode.DefaultVisibility'],
    )
